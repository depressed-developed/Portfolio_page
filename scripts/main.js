...
var characterList = ['webdev', 'front-end', 'html', 'css', 'sass', 'react', 'svelte', 'javascript', 'DOM', 'code', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z'];
...
var layers = {
    ...
    color: ['#00ADB5', '#018188'], //color of the letters (starting from the deepest layer)
